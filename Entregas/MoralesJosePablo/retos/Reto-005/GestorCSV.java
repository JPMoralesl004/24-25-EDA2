public class GestorCSV {
    ...
    public void ordenarIndice(String nombreColumna, int metodo) {
        int indiceColumna = obtenerIndiceColumna(nombreColumna);
        if (indiceColumna == -1 || !columnaIndexada[indiceColumna]) {
            System.out.println("No se puede ordenar. La columna no está indexada: " + nombreColumna);
            return;
        }

        indices[indiceColumna].ordenar(metodo);
        System.out.println("> Índice ordenado para la columna: " + nombreColumna);
    }
